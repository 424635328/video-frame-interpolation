...
train_dataset = VideoDataset(data_dir=train_data_dir,
                             ...
                             horizontal_flip=config.get('horizontal_flip', True)) # 添加 horizontal_flip
...
scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.1, patience=10, verbose=True) #factor 每次降低的比例，patience可以容忍的轮数
